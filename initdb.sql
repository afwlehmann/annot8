...
-- INSERT INTO movies VALUES ('Z:\Einzelbilder\Camcorder Alex\Camcorder_Alex_', '.jpg', 1, 7200, 5, 'Camcorder Alex');
-- INSERT INTO movies VALUES ('Z:\Einzelbilder\Camcorder Matthias\Camcorder_Matthias_', '.jpg', 1, 7200, 5, 'Camcorder Matthias');
-- INSERT INTO movies VALUES ('Z:\Einzelbilder\Grosse Kamera\Grosse_Kamera_', '.jpg', 1, 7200, 5, 'Grosse Kamera');
-- INSERT INTO movies VALUES ('Z:\Einzelbilder\Mobile Kamera\Mobile_Kamera_', '.jpg', 1, 7200, 5, 'Mobile Kamera');
-- INSERT INTO movies VALUES ('Z:\Einzelbilder\Webcam Georg\Webcam_Georg_', '.jpg', 1, 7200, 5, 'Webcam Georg');
...
-- INSERT INTO samples (participant_id, filename) VALUES ((SELECT id FROM participants WHERE name LIKE 'Lehmann'), 'Z:\Rekorder geschnitten\teiln01_000133_003233.wav');
-- INSERT INTO samples (participant_id, filename) VALUES ((SELECT id FROM participants WHERE name LIKE 'Groh'),    'Z:\Rekorder geschnitten\teiln03_000138_003238.wav');
-- INSERT INTO samples (participant_id, filename) VALUES ((SELECT id FROM participants WHERE name LIKE 'Lustig'),  'Z:\Rekorder geschnitten\teiln04_000130_003230.wav');
