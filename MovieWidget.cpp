    ...
    _imageProducer(0)
{
    ...
    connect(_imageProducer, SIGNAL(loadingFailed(const QString &)),
            SLOT(loadingOfImageFailed(const QString &)));
}
...
void MovieWidget::loadingOfImageFailed(const QString &reason)
{
